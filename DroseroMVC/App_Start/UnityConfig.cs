...
namespace DroseroMVC
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<ICategoryService<Category>, CategoryService<Category>>();
            container.RegisterType<ICategoryRepository<Category>, CategoryRepository<Category>>();
            container.RegisterType<IFoodItemService<FoodItem>, FoodItemService<FoodItem>>();
            ...
            container.RegisterInstance(typeof(IDataProvider), dataProvider);
        }
    }
}